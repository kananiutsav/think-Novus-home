...
import { toolsTechHeading } from '@/utils/Constant'
    ...
    return (
        <>
            <div className='max-w-[1200px] mx-auto pt-[80px]'>
                ...
                <div>
                    <div className='gap-[24px] h-[796px]'>
                        <div>
                        ...
                        </div>
                        {
                            data && data.map((item) => (
                                <div key={item.id} className='text-white flex bg-[#1A1825] py-[34px] px-[32px] gap-[39px] rounded-[10px] toolsborder mb-5'>
                                    <div className='w-[25%]'>
                                        <h3 className='text-[24px] items-center justify-center mt-3 font-[500] leading-[68.09px]'>{item.title}</h3>
                                    </div>
