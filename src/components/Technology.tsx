...
//                     {data && data.map((item) => (
//                         <SwiperSlide key={item.id}>
//                             <div className= 'square p-[28px] w-[400px] rounded-2xl  hover:border-2 border-2  border-solid  bg-[#1A1826] gap-x-[20px] '>
//                                 <div className='text-white w-[351px] flex flex-col items-start shrink-0'>
//                                     <div className='text-[22px] font-[500] leading-[32.755px] mb-5 gap-4 flex items-center'>
//                                         <Image
//                                             src={item.heading.img}
...
const Technology = ({ data }: SwiperData) => {
    ...
    return (
        <div className='max-w-[1440px]  mx-auto'>
            ...
            <div className='ml-[8%] our-prouct-slider '>
                <Swiper
                    slidesPerView={3.15}
                    spaceBetween={20}
                    navigation={{
                ...
                >
                    {data && data.map((item) => (
                        <SwiperSlide key={item.id}>
                            <div className='square p-[28px] w-[400px] rounded-2xl  hover:border-2 border-2  border-solid  bg-[#1A1826] gap-x-[5%] '>
                                <div className='text-white w-[351px] flex flex-col items-start shrink-0'>
                                    <div className='text-[22px] font-[500] leading-[32.755px] mb-5 gap-4 flex items-center'>
                                        <Image
                                            src={item.heading.img}
                                    ...
                                    <ul className='flex flex-col justify-center shrink-0 items-start '>
                                        {item.subHeading.map((subItem, index) => (
                                            <li key={index} className='flex  items-center mb-5 text-[18px] font-[500] gap-x-[5%] '>
                                                <Image src={subItem.img} width={30} height={30} alt='' />
                                                {subItem.title}
                                            </li>
                                        ))}
