...
const Expertise: React.FC<WebExpertisesData & WebQAData> = ({ data, ans }) => {
    return (
        <>
            <div className='max-w-[1200px] mx-auto flex justify-between  py-[50px] content ' >
                <div className='w-[438px]'>
                    {data && data.map((item) => (
                      ...
                      <div className='w-[712px] h-[503px] content'>
                    <div className='card p-[32px] w-[712px] h-[295px]  bg-[#1A1826] border-2 border-solid border-[#5B5B5B] rounded-[14px] '>
                    {ans && ans.map((item) => (
                    ...
                    <div className='card p-[32px] w-[712px] h-[295px]  bg-[#1A1826] border-2 border-solid border-[#5B5B5B] rounded-[14px] top-[36px]'>
                    {ans && ans.map((item) => (
                            <div key={item.id} className=''>
                                <div>
                                    <h1 className='text-white text-[30px] font-[600] leading-[31.5px] tracking-[0.74px]'>{item.heading}</h1>
                    ...
                    <div className='card p-[32px] w-[712px] h-[295px]  bg-[#1A1826] border-2 border-solid border-[#5B5B5B] rounded-[14px]  top-[72px]'>
                    {ans && ans.map((item) => (
                            <div key={item.id} className=''>
                                <div>
                                    <h1 className='text-white text-[30px] font-[600] leading-[31.5px] tracking-[0.74px]'>{item.heading}</h1>
                    ...
                    <div className='card p-[32px] w-[712px]     h-[295px]  bg-[#1A1826] border-2 border-solid border-[#5B5B5B] rounded-[14px]  top-[144px] '>
                        {ans && ans.map((item) => (
                            <div key={item.id} className=''>
                                <div>
                                    <h1 className='text-white text-[30px] font-[600] leading-[31.5px] tracking-[0.74px]'>{item.heading}</h1>
